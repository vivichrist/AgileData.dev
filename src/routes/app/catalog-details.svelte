...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-6 columns">
      ...
      <div class="row left-side">
        ...
        <div class="col-2 pl-0">
          <div
            class="nav nav-tabs tabs-right flex-column h-100"
            id="v-tabs-tab"
            role="tablist"
    ...
    <div class="col-md-6 columns">
      <textarea
        class="form-control my-5 right-side"
      ...
      <div class="input-group-append">
        <button
          ...
          <img
            width="15"
            height="15"
            src="/agiledata-logo-icon-purple-dropdown.svg"
            alt="dropdown" />
        </button>
